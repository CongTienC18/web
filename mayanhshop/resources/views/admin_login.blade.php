        ...
        <div class="w3layouts-main">
            ...
            <form action="{{ URL::to('/admin-dashboard') }}" method="post">
                ...
                @foreach ($errors->all() as $error)
                    {{ $error }}
                @endforeach
                <input type="text" class="ggg" name="admin_email" placeholder="tên đăng nhập">
                <input type="password" class="ggg" name="admin_password" placeholder="mật khẩu">
                {{-- <a href="#">Quên mật khẩu?</a> --}}
                <div class="clearfix"></div>
                <input type="submit" value="Đăng nhập" name="login">
                <a style="font-size:18px" href="{{ URL::to('/login-facebook') }}">Facebook</a> |
                
                <a style="font-size:18px" href="{{ URL::to('/login-google') }}">Google</a>
                {{-- Captcha --}}
